...
"Harkarn Rai". No code in this file is copied from any other source
...
def mon_max(month: int, year: int) -> int:
    ...
    elif month in [4, 6, 9, 11]:  # Corrected to include proper 30-day months
        return 30
    else:
        return 31
...
if __name__ == "__main__":
    ...
    # Check that second argument is a valid integer (+/-)
    try:
